...
public class PropaTrainTest {
    ...
    public static void importFiles(Connection connection) throws IOException, SQLException {
        ...
        connection.createStatement().execute("DROP TABLE RAIL_SECTIONS,Rail_Traffic,RECEPTEURS,Buildings,RAIL_PROTECT,DEM,LANDCOVER_G0,LANDCOVER_G1  IF EXISTS;");
    ...
    public void testNoiseEmissionRailWayForPropa() throws SQLException, IOException {
      ...
      //  List<String> configs = Arrays.asList("ref","ref_dem","ref_g","F0", "F1", "F2", "F3", "C0","C1","C2","C3","C4","C5","C6");
        ...
        for (String configName : configs) {
            ...
            // dem
            boolean dem = false;
            if (configName.equals("ref_dem") ||
                    configName.equals("F0") ||
            ...
            if (configName.equals("ref") ||
                    configName.equals("ref_dem") ||
                    configName.equals("ref_g") ||
                    configName.equals("F0") ||
                    configName.equals("F1") ||
                    configName.equals("F2") ||
            ...
            pointNoiseMap.setMaximumReflectionDistance(800.0);
            ...
            try {
                ...
                for(PointNoiseMap.CellIndex cellIndex : new TreeSet<>(cells.keySet())) {
                    ...
                    if (out instanceof ComputeRaysOutAttenuation) {
                        ...
                        exportScene(String.format(Locale.ROOT,"target/scene_%d_%d_"+configName+".kml", cellIndex.getLatitudeIndex(), cellIndex.getLongitudeIndex()), cellStorage.inputData.profileBuilder, cellStorage);
                    }
                }
            }finally {
                factory.stop();
        ...
        SHPDriverFunction shpDriver = new SHPDriverFunction();
        shpDriver.exportTable(connection, "LW_RAILWAY", new File("target/LW_RAILWAY.shp"), true, new EmptyProgressVisitor());
        connection.close();
