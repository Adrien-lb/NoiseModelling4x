...
class TestNoiseModelling extends JdbcTestCase {
    ...
    @Test
    void testRailWayEmissionFromDEN2() {
        ...
        new Import_File().exec(connection,
                ["pathFile" : TestNoiseModelling.getResource("Train/casTest/Dpt41/SEC_RAIL_41.shp").getPath(),
        ...
        new Import_File().exec(connection,
                ...
                ["pathFile" : TestNoiseModelling.getResource("Train/casTest/Dpt41/TRAF_RAIL_41.dbf").getPath(),
