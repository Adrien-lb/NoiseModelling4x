...
inputs = [
        ...
        tableSources            : [
                ...
                description: 'Name of the Sources table (if only geometry is specified) </br> </br>' +
                        ...
                        '<li> <b> LWD50 ,LWD63 ,LWD80 , LWD100 ,LWD125 ,LWD160 , LWD200 ,LWD250 ,LWD315 , LWD400 ,LWD500 ,LWD630 , LWD800 ,LWD1000 ,LWD1250 , LWD1600 ,LWD2000 ,LWD2500 , LWD3150 ,LWD4000 ,LWD5000 , LWD6300 ,LWD8000 ,LWD10000 </b> : 24 columns giving the day emission sound level for each third octave band (FLOAT) </li> ' +
                        '<li> <b> LWE </b> : 24 columns giving the evening emission sound level for each third octave band (FLOAT) </li> ' +
                        '<li> <b> LWN </b> : 24 columns giving the night emission sound level for each third octave band (FLOAT) </li> ' +
        ...
        tableSourceDirectivity          : [
                ...
                description: 'Name of the emission directivity table </br> </br>' +
                        ...
                        '<li> <b> LWD50 ,LWD63 ,LWD80 , LWD100 ,LWD125 ,LWD160 , LWD200 ,LWD250 ,LWD315 , LWD400 ,LWD500 ,LWD630 , LWD800 ,LWD1000 ,LWD1250 , LWD1600 ,LWD2000 ,LWD2500 , LWD3150 ,LWD4000 ,LWD5000 , LWD6300 ,LWD8000 ,LWD10000 </b>: attenuation levels in dB for each octave or third octave (FLOAT) </li> </ul> ' ,
                min        : 0, max: 1, type: String.class
        ],
